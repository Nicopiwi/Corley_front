...
class CreditCard extends Component {
    ...
    getImage(){
      if (this.props.type !== 'visa' && this.props.type !== 'mastercard'){
        return null
      }else{
        return this.props.type === 'visa' ? images.default.visa:images.default.mastercard
      }
    }
    updateType(props) {
                                ...
                                <View style={styles.rowWrap}>
                                    ...
                                    {showExpiryAfterLabel &&
                                        <View style={styles.validthru}>
                                            <Text style={styles.textValidThru}>{expiryAfterText || 'VALIDO HASTA'}</Text>
                                        </View>
                                    }
                                    <View
                                        style={styles.expiry}
                                        ...
                                        {showExpiryBeforeLabel && 
                                            <Text style={styles.textSmall}>{expiryBeforeText || 'MES/AÑO'}</Text>
                                        }
